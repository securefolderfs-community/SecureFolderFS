...
namespace SecureFolderFS.Sdk.Storage.Devices
{
    ...
    {
        /// <summary>
        /// Tries to get unknown root of the device.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Task"/> that represents the asynchronous operation. If successful, returns <see cref="IEnumerable{T}"/> of type <see cref="IBaseStorage"/>, otherwise false.</returns>
