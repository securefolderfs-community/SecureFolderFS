...
namespace SecureFolderFS.Sdk.Storage.Devices
{
    ...
    public interface IDeviceRoot
    {
        ...
        /// </summary>
        /// <returns>A <see cref="Task"/> that represents the asynchronous operation. If successful, returns <see cref="object"/> that represents the device root, otherwise null.</returns>
        ...
        /// </summary>
        /// <returns>A <see cref="Task"/> that represents the asynchronous operation. If successful, returns <see cref="IEnumerable{T}"/> of type <see cref="IStorable"/>, otherwise null.</returns>
