...
namespace SecureFolderFS.UI.ViewModels.Health
{
    ...
    public sealed partial class HealthNameIssueViewModel : HealthIssueViewModel
    {
        ...
        partial void OnIsEditingChanged(bool value)
        {
            ...
            ErrorMessage = wasNameChanged ? "GenerateNewNameChanged".ToLocalized() : "GenerateNewName".ToLocalized();
        }
        ...
        private async Task EditAsync()
        {
            ...
            var overlayViewModel = new RenameOverlayViewModel("Rename".ToLocalized()) { Message = "GenerateNewName".ToLocalized(), NewName = newName };
