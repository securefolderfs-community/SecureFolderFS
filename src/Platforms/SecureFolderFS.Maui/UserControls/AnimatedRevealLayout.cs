...
/// </summary>
public class AnimatedRevealLayout : Grid
{
    private const uint AnimationDuration = 250U;
    ...
    private async Task AnimateRevealAsync(bool show)
    {
        ...
        animation.Commit(this, "RevealAnimation", length: AnimationDuration);

        // Await by waiting for the animation to finish
        await Task.Delay((int)AnimationDuration + 16);
    ...
    private double GetNaturalSize()
    {
        ...
        return IsHorizontal
            ...
            : _revealView.HeightRequest > 0d ? _revealView.HeightRequest : _revealView.Height;
    }
