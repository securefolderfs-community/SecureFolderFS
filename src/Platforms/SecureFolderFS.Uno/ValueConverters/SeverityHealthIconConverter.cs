...
#else
            new BitmapImage(new("ms-appx:///Assets/AppAssets/Shields/success_shield.png"));
#endif
...
#else
            new BitmapImage(new("ms-appx:///Assets/AppAssets/Shields/warning_shield.png"));
#endif
...
#else
            new BitmapImage(new("ms-appx:///Assets/AppAssets/Shields/error_shield.png"));
#endif
