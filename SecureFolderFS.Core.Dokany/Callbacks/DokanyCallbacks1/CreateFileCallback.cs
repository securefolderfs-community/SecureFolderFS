...
{
    internal sealed class CreateFileCallback : BaseDokanCallback, ICreateFileCallback
    {
        public CreateFileCallback(string vaultRootPath, IPathConverter pathConverter, HandlesManager handlesManager)
