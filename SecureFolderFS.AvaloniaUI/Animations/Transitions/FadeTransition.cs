...
{
    internal sealed class FadeTransition : Transition
    {
        public required AnimationMode Mode { get; set; }

        /// <summary>
        /// Gets or sets whether to change visibility of the target before and after running the animation.
        /// </summary>
        public bool UpdateVisibility { get; set; }

        /// <exception cref="ArgumentException">Target doesn't implement IVisual</exception>
        protected override async Task RunAnimationAsync(Visual target)
        {
