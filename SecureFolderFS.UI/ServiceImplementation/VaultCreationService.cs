...
namespace SecureFolderFS.UI.ServiceImplementation
{
    ...
    public sealed class VaultCreationService : IVaultCreationService
    {
        ...
        public async Task<IResult> PrepareConfigurationAsync(CancellationToken cancellationToken = default)
        {
            ...
            var configFile = await _folder.TryCreateFileAsync(Core.Constants.Vault.VAULT_CONFIGURATION_FILENAME, false, cancellationToken);
