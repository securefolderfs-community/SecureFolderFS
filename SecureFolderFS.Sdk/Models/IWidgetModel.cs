...
namespace SecureFolderFS.Sdk.Models
{
    ...
    public interface IWidgetModel
    {
        ...
        Task<object?> GetData(string key, CancellationToken cancellationToken = default);
        ...
        Task<bool> SetData(string key, object? value, CancellationToken cancellationToken = default);
    }
}
