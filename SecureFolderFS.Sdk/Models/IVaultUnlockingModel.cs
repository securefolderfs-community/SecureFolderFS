...
namespace SecureFolderFS.Sdk.Models
{
    ...
    public interface IVaultUnlockingModel : IDisposable
    {
        ...
        /// <param name="cancellationToken">A <see cref="CancellationToken"/> that cancels this action.</param>
        /// <returns>A <see cref="Task"/> that represents the asynchronous operation. Value is <see cref="IResult{T}"/> of type <see cref="IUnlockedVaultModel"/> of the action.</returns>
